...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_MEM0_TYPE {1} CONFIG.C_TAVDV_PS_MEM_0 {70000} CONFIG.C_TCEDV_PS_MEM_0 {70000} CONFIG.C_THZCE_PS_MEM_0 {8000} CONFIG.C_THZOE_PS_MEM_0 {8000} CONFIG.C_TPACC_PS_FLASH_0 {70000} CONFIG.C_TWC_PS_MEM_0 {85000} CONFIG.C_TWPH_PS_MEM_0 {10000} CONFIG.C_TWP_PS_MEM_0 {55000} CONFIG.EMC_BOARD_INTERFACE {cellular_ram} CONFIG.USE_BOARD_FLOW {true}  ] $axi_emc_0
  ...
  set_property -dict [ list CONFIG.REF_CLK_BOARD_INTERFACE {sys_clock} CONFIG.RESET_BOARD_INTERFACE {reset} CONFIG.RMII_BOARD_INTERFACE {eth_rmii}  ] $mii_to_rmii_0
  ...
  create_bd_addr_seg -range 0x1000000 -offset 0x60000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_emc_0/S_AXI_MEM/MEM0] SEG_axi_emc_0_MEM0
  create_bd_addr_seg -range 0x1000000 -offset 0x60000000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_emc_0/S_AXI_MEM/MEM0] SEG_axi_emc_0_MEM0
