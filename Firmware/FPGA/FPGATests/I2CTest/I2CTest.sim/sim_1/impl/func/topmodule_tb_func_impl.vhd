...
-- Date        : Wed Jan 27 15:14:29 2016
-- Host        : ALI-WORKSTATION running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               D:/GroupProject/WindTunnelApparatus/Firmware/FPGA/FPGATests/I2CTest/I2CTest.sim/sim_1/impl/func/topmodule_tb_func_impl.vhd
-- Design      : topmodule
...
architecture STRUCTURE of STD_FIFO is
  ...
  signal Memory_reg_ENARDEN_cooolgate_en_sig_1 : STD_LOGIC;
  ...
  attribute IS_CLOCK_GATED of Memory_reg : label is std.standard.true;
  attribute METHODOLOGY_DRC_VIOS : string;
  attribute METHODOLOGY_DRC_VIOS of Memory_reg : label is "{SYNTH-6 {cell *THIS*}}";
  attribute POWER_OPTED_CE : string;
  attribute POWER_OPTED_CE of Memory_reg : label is "ENARDEN=AUG";
...
Memory_reg_ENARDEN_cooolgate_en_gate_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"4"
    )
        port map (
...
entity topmodule is
  ...
  attribute ECO_CHECKSUM of topmodule : entity is "9efb0088";
  attribute POWER_OPT_BRAM_CDC : integer;
  attribute POWER_OPT_BRAM_CDC of topmodule : entity is 0;
  attribute POWER_OPT_BRAM_SR_ADDR : integer;
  attribute POWER_OPT_BRAM_SR_ADDR of topmodule : entity is 0;
  attribute POWER_OPT_LOOPED_NET_PERCENTAGE : integer;
  attribute POWER_OPT_LOOPED_NET_PERCENTAGE of topmodule : entity is 0;
end topmodule;
